...
INSERT INTO `sgstt`.`trasladista` (`idtrasladista`,`idsede`, `nombre`, `apellido`, `dni`, `direccion`, `correo`, `telefono`, `celular`, `estado`) VALUES (10, 1, 'Guillermo', 'Torres', '00000000', 'Enrique Barr�n N� 845 � Dpto. 202 � Santa Beatriz / Referencia al frente del parque de las aguas.', 'No disponible', '5457854', '965874123', 1);
...
INSERT INTO `sgstt`.`empresa` (`idempresa`,`idsede`, `razon_social`, `ruc`,`centrocosto`, `telefono`, `celular`, `correo`, `estado`) VALUES (28, 1, 'TRANSP.WI�ATOUR', NULL,"VT-28", NULL, NULL, NULL,1);
...
INSERT INTO `sgstt`.`chofer` (`idchofer`, `idsede`, `nombre`, `apellido`, `dni`, `categoria`,`fecha`, `estado`,`idempresa`) VALUES (2, 2, 'CESAR AMADO', 'ARELLANOS MU�OZ', '25662462', 'A2',"2015-11-07 00:00:00", 1,1);
...
INSERT INTO `sgstt`.`chofer` (`idchofer`, `idsede`, `nombre`, `apellido`, `dni`, `categoria`,`fecha`, `estado`,`idempresa`) VALUES (9, 1, 'JOSE LUIS', 'NU�EZ CUENCA ROJAS', '09461980', 'A3',"2015-11-07 00:00:00", 1,1);
...
INSERT INTO `sgstt`.`aerolinea` (`idaerolinea`, `descripcion`) VALUES (2, 'Aerol�neas Argentinas');
INSERT INTO `sgstt`.`aerolinea` (`idaerolinea`, `descripcion`) VALUES (3, 'AeroM�xico');
...
INSERT INTO `sgstt`.`aerolinea` (`idaerolinea`, `descripcion`) VALUES (16, 'Lan Per�');
INSERT INTO `sgstt`.`aerolinea` (`idaerolinea`, `descripcion`) VALUES (17, 'LC Per�');
...
INSERT INTO `sgstt`.`aerolinea` (`idaerolinea`, `descripcion`) VALUES (21, 'Star Per�');
INSERT INTO `sgstt`.`aerolinea` (`idaerolinea`, `descripcion`) VALUES (22, 'Taca Per�');
