...
CREATE  TABLE IF NOT EXISTS `sgstt`.`vehiculo` (
  ...
  `estado` TINYINT(1) NOT NULL DEFAULT 1 ,
  `a�o_fabricacion` VARCHAR(4) NULL ,
...
INSERT INTO destinos VALUES (104,1,'Complejo Arqueol�gico Cerro Sech�n y Museo de Siti','Complejo Arqueol�gico Cerro Sech�n y Museo de Siti',NULL,'5 km al sureste de la localidad de Casma','+51 (043) 721521','http://www.arqueotur.org','LIMA',NULL,NULL,'Museo',1);
